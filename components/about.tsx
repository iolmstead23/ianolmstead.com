    ...
    return (
        <div className="flex flex-row flex-wrap justify-center my-10">
            ...
            <div className="text-2xl mx-10 my-[15px]">
                ...
                I have skills in Javascript and Python. I got my <Link href="https://eportfolio.mygreatlearning.com/ian-olmstead">certificate from MIT</Link> in Applied Data Science. This website was built using Next.js and hosted using Vercel.
            </div>
        </div>
    )
}